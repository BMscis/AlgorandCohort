...
import { scrollToTop, withProps } from '../../utils';
import * as backend from '../../smartContract/index.main.mjs';
import { newAvatar, newBids, newOwner, UpdateAuthor, UpdateNFTS } from '../../core/store';
  ...
  async deploy() {
    ...
    if (this.contract) {
      ...
      if (didBuy) {
        ...
        const newNftBids = nftBids ? [...nftBids, bid] : [bid];
        const newAuthBids = authorBids ? [...authorBids, bid] : [bid];
        const resp = await UpdateNFTS(this.state.nft.id, ticketSold, newNftBids);
        const resp2 = await UpdateAuthor(this.context.user.id, newAuthBids);
        if (resp && resp2) {
          ...
          {this.state.nft && (
            <div className="row mt-md-5 pt-md-4">
              <div className="col-md-6 text-center">
                <img
                  src={this.state.nft.preview_image.url}
                ...
                <div className="item_info">
                  ...
                  <div className="item_info_counts">
                    ...
                    <div className="item_info_views">
                      <i className="fa fa-eye"></i> {this.state.nft.views}{' '}
                    </div>
                    <div className="item_info_like">
                      <i className="fa fa-heart"></i>
                      {this.state.nft.likes}{' '}
                    </div>
                  </div>
                  ...
                  <div className="p_list_info">
                    <span>
                      <span>
                        Price{' '}
                        <b>
                          {this.state.nft.price} {this.state.nft.chain}
                        </b>
                      </span>

                      {/* button for checkout */}
                      <span className="d-flex flex-row mt-5">
                        <button className="btn-main lead mb-5 mr15" onClick={this.openCheckoutCard}>
                          Buy Now
                        </button>
                  ...
                  <div className="de_tab">
                    <ul className="de_nav">
                      <li id="Mainbtn2" className="active">
                        <span onClick={this.handleBtnClick2}>Artists</span>
                      </li>
                      <li id="Mainbtn" className="">
                        <span onClick={this.handleBtnClick}>Attending</span>
                      </li>
          ...
          <div className="checkout">
            ...
            {this.state.event && (
              <div className="maincheckout">
                <button className="btn-close" onClick={this.closeCheckoutCard}>
                  x
                </button>
                ...
                <p>
                  You are about to purchase a<p className="bold">{this.state.nft.title}</p>
                  <span className="bold">from {this.state.nft.owner.username}</span>
                </p>
                <div className="detailcheckout mt-4">
                  <div className="listcheckout">
                    <h6>
                      Enter quantity.
                      <div className="color">
                        Tickets Remaining: {this.state.event.tickets - this.state.event.ticketSold}
                      </div>
                    </h6>
                    <input
                      type="number"
                ...
                <div className="heading mt-3">
                  <p>Your balance</p>
                  <div className="subtotal">10.67856 {this.state.nft.chain}</div>
                </div>
                <div className="heading">
                  <p>Service fee 2.5%</p>
                  <div className="subtotal">0.00325 {this.state.nft.chain}</div>
                </div>
                <div className="heading">
                  <p>You will pay</p>
                  <div className="subtotal">0.013325 {this.state.nft.chain}</div>
                </div>
                <button className="btn-main lead mb-5" onClick={this.deploy}>
                  {' '}
                  Checkout
                </button>
              </div>
        ...
        {this.openCheckoutbid && (
          <div className="checkout">
            <div className="maincheckout">
              ...
              <div className="detailcheckout mt-4">
                <div className="listcheckout">
                  <h6>Your bid ({this.state.nft.chain})</h6>
