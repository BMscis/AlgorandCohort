...
import { scrollToTop, SendToS3, withRouter } from '../../utils';
import * as backend from '../../smartContract/index.main.mjs';
import { createGlobalStyle } from 'styled-components';
import Loading from '../components/loading';
import { Itemtype, Nftcategory, Nftcollectiontype, Nftstatus } from '../../models';
import { DataStore } from 'aws-amplify';
import SmartError from '../components/error/SmartError';
import { newArtists, newAvatar, newEventInfo, newNFTS, newOwner } from '../../core/store';
const topStyle = {
